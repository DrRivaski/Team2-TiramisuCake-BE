...
public enum StaticText {
    ...
    DRAW_FIRST_WINNER_MODAL_SUBTITLE("아이패드에 당첨됐어요!"),
    DRAW_SECOND_WINNER_MODAL_SUBTITLE("현대백화점 쿠폰 10만원권에 당첨됐어요!"),
    DRAW_THIRD_WINNER_MODAL_SUBTITLE("현대백화점 쿠폰 1만원권에 당첨됐어요!"),
